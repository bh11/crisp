...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Section{Functions for the socle}\null
...
\index{normal subgroups!related to radicals}


\>OneInvariantSubgroupMaxWrtNPropertyUnderAction(<act>, <grp>, <pretest>, <test>, <data>) O
...
`OneInvariantSubgroupMaxWrtNPropertyUnderAction' computes an <act>-invariant subgroup $M \in
...
this case, `OneInvariantSubgroupMaxWrtNPropertyUnderAction' will return the $\cal
X$-radical of <grp>.
...
`OneInvariantSubgroupMaxWrtNPropertyUnderAction'. $<U>/<V>$ is an <act>-composition factor of
...
<data> is never used or changed by `OneInvariantSubgroupMaxWrtNPropertyUnderAction', but
exists only as a means for passing additional information to or between
the functions <pretest> and <test>.

\>AllInvariantSubgroupsWithNPropertyUnderAction(<act>, <grp>, <pretest>, <test>, <data>) O
...
the documentation of `OneInvariantSubgroupMaxWrtNPropertyUnderAction' (see
"OneInvariantSubgroupMaxWrtNPropertyUnderAction") for details.

\beginexample
gap> D := DihedralGroup (8);;
gap> AllInvariantSubgroupsWithNPropertyUnderAction (
> D, D,
>     ReturnFail,
>     function (R, S, data)
>         return IsAbelian (R);
...
are the same as `OneInvariantSubgroupWithNPropertyUnderAction' (see
"OneInvariantSubgroupMaxWrtNPropertyUnderAction")
and  `AllInvariantSubgroupsWithNPropertyUnderAction' ((see
"AllInvariantSubgroupsWithNPropertyUnderAction"), where $<act> = <grp>$, and thus the
