...
This method simply calls `AllInvariantSubgroupsWithQPropertyUnderAction' with
$<act> = <grp>$, `ReturnTrue'
...
`CharacteristicSubgroups' calls `AllInvariantSubgroupsWithQPropertyUnderAction'.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Section{Low level functions for normal subgroups related to residuals}\null

\index{normal subgroups!related to residuals}

\>OneInvariantSubgroupMinWrtQPropertyUnderAction(<act>, <grp>, <pretest>, <test>, <data>) O
...
<data> is never used or changed by `OneInvariantSubgroupMinWrtQPropertyUnderAction', but
...
`OneInvariantSubgroupMinWrtQPropertyUnderAction' will return the $\cal C$-residual of
<grp>.

The following example shows how to use `OneInvariantSubgroupMinWrtQPropertyUnderAction' to
...
>       x -> Comm (x[1],x[2])));;
gap> OneInvariantSubgroupMinWrtQPropertyUnderAction (
>    G, G,
...
\>AllInvariantSubgroupsWithQPropertyUnderAction(<act>, <grp>, <pretest>, <test>, <data>) O

`AllInvariantSubgroupsWithQPropertyUnderAction' returns a list consisting of all 
<act>-invariant subgroups in $\cal X$, where $\cal X$ is the class defined by <pretest>,
<test>, and <data>, as described for `OneInvariantSubgroupMinWrtQPropertyUnderAction' (see
"OneInvariantSubgroupMinWrtQPropertyUnderAction"). 
At present, there exist only methods for finite solvable groups <grp>.
...
> AllInvariantSubgroupsWithQPropertyUnderAction (G, G, 
>    function (U, V, R, data)
...
`OneInvariantSubgroupMinWrtQPropertyUnderAction' (see
"OneInvariantSubgroupMinWrtQPropertyUnderAction"), where $<act> = <grp>$. 

\>AllNormalSubgroupsWithQProperty(<grp>, <pretest>, <test>, <data>) O

`AllNormalSubgroupsWithQProperty' is the same as 
`AllInvariantSubgroupsWithQPropertyUnderAction' (see
"AllInvariantSubgroupsWithQPropertyUnderAction"), where $<act> = <grp>$. 
